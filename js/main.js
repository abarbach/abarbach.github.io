$(document).ready(function() {
	...
	var sliderResource2 = $( "<div id='slider-resource-2'></div>" ).insertAfter( selectResource2 ).slider({
		...
		change: function(event, ui) { 
				...
				$('#resource-2-amount').html(sliderValueResource2);
					if(sliderValueResource2 == '200000') {
						progressBarResource2(20, $('#progressBarResource2'));
					...
					else if (sliderValueResource2 == '399999') {
						progressBarResource2(40, $('#progressBarResource2'));
						$('#decrease-resource-2').removeClass('btn-disabled');
					}
					else if (sliderValueResource2 == '600000') {
						progressBarResource2(60, $('#progressBarResource2'));
						}
					else if (sliderValueResource2 == '599999') {
						progressBarResource2(60, $('#progressBarResource2'));
					}
					else if (sliderValueResource2 == '800000') {
						progressBarResource2(80, $('#progressBarResource2'));
						$('#increase-resource-2').removeClass('btn-disabled');
						}
					else if (sliderValueResource2 == '799999') {
						var sliderCurrentResource2Value = $( "#slider-resource-2" ).slider( "option", "value" );
		                sliderResource2.slider( "value", 800000);
					}
					else if (sliderValueResource2 == '999999') {
	...
	$('#increase-resource-2').click(function() {
		var sliderCurrentResource2Value = $( "#slider-resource-2" ).slider( "option", "value" );
		sliderResource2.slider( "value", sliderCurrentResource2Value + 200000 );	
	});
	...
	$('#second-step-button').click(function() {	
		...
		progressBar(0, $('#progressBarConsole'));
		$('.message-header h3').html("Online Generator");	
		$('.message-header p.message-header-subtitle').html("You are about to generate resources");		
		$(".message-content p.console-message").fadeIn();	
		var $console_message_username_msg = $('#coc-player-tag').val();
		var $console_message_platform_msg = $('#coc-player-platform').val();
		...
		if ($("#slider-resource-2").length === 0){
			setTimeout(function() {	
			$('.console-resourceitem1-wrapper').fadeOut();
			$(".message-content p.console-message").typed({
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit Clash Royale stuff generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all stuff for himself haha');
